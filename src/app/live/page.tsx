    ...
    <main className="relative min-h-screen bg-[#020205] pb-28 text-white">
      <div className="mx-auto flex max-w-[640px] flex-col gap-6 px-4 pt-5">
        ...
        <header className="-mx-4 px-4">
          ...
          {/* Live pulse */}
          <div className="flex items-center justify-center gap-1.5 pb-0.5 pt-2">
              ...
              {liveRooms.map((room) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: `url('${room.poster}')`,
              ...
              >
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex min-w-0 flex-1 flex-col gap-[2px]">
                    <div className="flex items-center gap-1.5">
                      <span
                        className="rounded-full px-1 py-px text-[0.34rem] font-semibold uppercase tracking-[0.05em]"
                        style={{
                          color: item.labelColor,
                          backgroundColor: `${item.labelColor}15`,
                          border: `1px solid ${item.labelColor}30`,
                        }}
                      >
                        {item.label}
                      </span>
                      <span className="text-[0.52rem] font-semibold text-white/80">{item.user}</span>
                      <span className="ml-auto text-[0.4rem] text-slate-500">{item.show}</span>
                    </div>
        ...
        <section className="space-y-2">
          ...
          <div className="space-y-px">
            {discussionPrompts.map((prompt) => {
              const color = discussionTheme[prompt.category] ?? "#94a3b8";
              return (
                <button
                  key={prompt.id}
